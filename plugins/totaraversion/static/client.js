plugins.totaraversion = {

    html: null,

    start: function() {
        dashletbase = ('<div class="plugin" id="totaraversion"> \
                <h1>Totara Version Sitrep</h1> \
                <div class="lastchange"></div> \
                </div>');
        $('div#body').append(dashletbase);
        $.getScript(base_url + '/plugin/totaraversion/jquery.timeago.js');
    },
    ...
    receiveData: function(data) {
        ...
        var dashletdiv = $('div#totaraversion');
        ...
        for (version in data['totarainfo']) { //eg v in (1.9, 2.1 ...)
            var versioninfo = data['totarainfo'][version] // Info about this version of totara.
            divid = 'totaraversion' + version // eg totaraversion1.9
